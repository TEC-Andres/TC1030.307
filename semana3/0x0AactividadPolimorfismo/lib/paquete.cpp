...
Paquete::Paquete(Envio& envio, double largo, double ancho, double profundo, double peso, double costoPorKilogramo) : Envio(envio) {
    this->largo = largo;
    this->ancho = ancho;
    this->profundo = profundo;
    this->peso = peso;
...
double Paquete::calculaCosto(double peso, double distancia) const {
