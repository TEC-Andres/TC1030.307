...
uint32_t Envio::getCodigoPostalRemitente() const {
...
uint32_t Envio::getCodigoPostalDestinatario() const {
...
double Envio::calculaCosto(double peso, double distancia) const {
